...
Option 2) The AppImage release file can be downloaded and executed on all 32 and 64 bit Linux distributions. No 
          installation process is required because the file is completely self-contained.
