...
def addAxisPoint (curvePoints, identifierNumber, ordinal, xScreen, yScreen, xGraph, yGraph):
...
addAxisPoint (curvePoints, 209, 1, 45, 327, 0, -1.5)
addAxisPoint (curvePoints, 211, 2, 587, 171, 14, 0)
addAxisPoint (curvePoints, 213, 3, 45, 15, 0, 1.5)
...
addGraphPoint (curvePoints, 290, 0, 55, 96)
