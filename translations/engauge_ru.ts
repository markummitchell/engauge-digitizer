...
Показать все оцифрованные оси и кривые графика.</translation>
    ...
    <message>
        ...
        <translation>Скрыть руководство</translation>
    </message>
    <message>
...
Guidelines are hidden to simplify the main window.</source>
        <translation>Скрыть руководство

Руководства скрыты, чтобы упростить главное окно.</translation>
    </message>
    <message>
        <location filename="../src/Create/CreateActions.cpp" line="560" />
        <source>Edit Guidelines</source>
        <translation>Редактировать рекомендации</translation>
    </message>
    <message>
...
This option is available in Select mode.</source>
        <translation>Редактировать рекомендации

	Добавьте новые рекомендации, щелкнув панель инструментов рекомендаций, переместите существующие рекомендации путем перетаскивания или удалите рекомендации, перетащив их из главного окна.
...
Добавьте новые рекомендации, щелкнув панель инструментов рекомендаций, переместите существующие рекомендации путем перетаскивания или удалите рекомендации, перетащив их из главного окна.</translation>
    ...
    <message>
        ...
        <translation>Руководство по замку</translation>
    </message>
    <message>
...
Lock the guidelines to prevent accidental movement or removal.</source>
        <translation>Руководство по замку

Заблокируйте направляющие, чтобы предотвратить случайное движение или удаление.</translation>
    </message>
    <message>
...
When pressed, a constant R (range) guideline is created. It can be moved by dragging</source>
        <translation>Создайте директиву R (Range)

При нажатии создается постоянная направляющая R (диапазон). Это может быть перемещено перетаскиванием</translation>
    </message>
    <message>
...
When pressed, a constant T (theta) guideline is created. It can be moved by dragging</source>
        <translation>Создать руководство по Т (Тета)

При нажатии создается постоянная T (тета) направляющая. Это может быть перемещено перетаскиванием</translation>
    </message>
    <message>
...
When pressed, a constant X guideline is created. It can be moved by dragging</source>
        <translation>Создать директиву X

При нажатии создается постоянная направляющая X. Это может быть перемещено перетаскиванием</translation>
    </message>
    <message>
...
When pressed, a constant Y guideline is created. It can be moved by dragging</source>
        <translation>Создать направляющую Y

При нажатии создается постоянная направляющая Y. Это может быть перемещено перетаскиванием</translation>
    </message>
</context>
<context>
...
Set the color of the guidelines that can be dragged from the edges of the scene, and used to align points</source>
        <translation>Руководство Цвет

Установите цвет направляющих, которые можно перетаскивать с краев сцены и использовать для выравнивания точек</translation>
    </message>
</context>
<context>
