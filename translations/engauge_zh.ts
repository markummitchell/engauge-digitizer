...
<context>
    ...
    <message>
        ...
        <translation type="vanished">&lt;p&gt;已创建清单指南. &lt;/p&gt;&lt;br/&gt;&lt;br/&gt;&lt;br/&gt;&lt;p&gt;&lt;font color=&quot;red&quot;&gt;为什么导入的图像看起来有些差异？&lt;/font&gt; 图像导入后, 筛选的图像为背景. 筛选后的图像在原始图像的基础上通过设置/颜色筛选 中的参数产生. 当参数设置正确的时候, 不重要的信息(例如网格线和背景颜色)将会被移除, 这样可以自动提取图像中的组件. 如果所需的组件已经被移除，则可调整  设置/颜色筛选 中的参数, 或者通过 视图/背景/显示原始图像 来显示原始图像.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">待数字化的曲线名称是什么？至少输入一条.</translation>
    </message>
    <message>
        <source>&lt;p&gt;How are those curves drawn?&lt;/p&gt;</source>
        <translation type="vanished">那些曲线是如何绘画的？</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">只要图像有坐标轴和/或网格线来确定坐标系, Engauge就可其转换为数字.&lt;/p&gt;&lt;p&gt;本向导创建一个步骤清单, 按步骤操作，即可导出所需点的坐标, 同时提供了Engauge最有用功能的概要.</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">坐标轴点模式</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">对于 线段填充 模式</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">移动光标至曲线. 如果未显示出线, 那么请调整曲线的颜色.</translation>
    </message>
    <message>
        <source>Move the cursor over the curve again. When the &lt;b&gt;Segment Fill&lt;/b&gt; line appears, click on it to generate points</source>
        <translation type="vanished">再次移动光标至曲线. 如果线段填充线显示出来，那么点击来产生点.</translation>
    </message>
    <message>
        <source>for &lt;b&gt;Point Match&lt;/b&gt; mode</source>
        <translation type="vanished">对于 点匹配 模式</translation>
    </message>
    <message>
        ...
        <translation type="vanished">移动光标至曲线上一个典型的点. 如果光标的颜色没有变化，那么可以在&lt;b&gt;颜色过滤器&lt;/b&gt;中对该曲线进行设置.</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">选择菜单&lt;b&gt;文件/导出&lt;/b&gt;</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation type="vanished">选择菜单 &lt;b&gt;查看 / 背景 / 显示原始图像 &lt;/b&gt; 查看原始图像</translation>
    </message>
    <message>
        <source>Select menu option &lt;b&gt;View / Background / Show Filtered Image&lt;/b&gt; to see the image from &lt;b&gt;Color Filter&lt;/b&gt;</source>
        <translation type="vanished">选择菜单 &lt;b&gt; 查看 / 背景 / 显示筛选的图像 &lt;/b&gt; 查看图像 &lt;b&gt;颜色筛选&lt;/b&gt;</translation>
    </message>
    <message>
        <source>Select menu option &lt;b&gt;Settings / Color Filter&lt;/b&gt;</source>
        <translation type="vanished">选择菜单 &lt;b&gt; 设置 / 颜色筛选 &lt;/b&gt;</translation>
    </message>
    <message>
...
Degrees Minutes Seconds (DDD MM SS.S) format uses two integer number for degrees and minutes, and a real number for seconds. There are 60 seconds per minute. During input, spaces must be inserted between the three numbers.</source>
        <translation>数字具有最简单和最通用的格式。日期和时间值具有日期和/或时间分量。度数分钟（DDD MM SS.S）格式使用两个整数来表示度和分钟数，而一个实数秒。每分钟有60秒。在输入过程中，必须在三个数字之间插入空格。</translation>
    </message>
    <message>
...
<context>
    ...
    <message>
        ...
        <translation type="vanished">添加/删除曲线</translation>
    </message>
    <message>
...
There must always be at least one curve</source>
        <translation>从曲线列表中删除当前选择的曲线。必须至少有一条曲线</translation>
    </message>
    <message>
...
Reorder curves by dragging them around.</source>
        <translation>属于该文件的曲线列表。点击曲线名称进行编辑。每个曲线名称必须是唯一的。by通过拖动曲线重新排列曲线。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>将未来图形曲线的默认值重置为原始设置。</translation>
    </message>
    <message>
...
This applies only to graph curves. No lines are ever drawn between axis points.</source>
        <translation>选择用直线连接点的规则。如果曲线连接为单值函数，则通过增加自变量的值来对点进行排序。如果曲线连接为闭合轮廓，则点是按照年龄排序，除了沿现有线放置的点数外。在任何现有线上放置的任何点都插入该线的两个端点之间，就好像它的年龄介于两个端点的年龄之间一样。在连续排序的点之间绘制线。直线绘制直线连续点之间的连线。平滑曲线在连续点之间用平滑线绘制。这仅适用于图形曲线。轴点之间不会画线。</translation>
    </message>
    <message>
...
The order of the curves here does not affect the order in the exported file. That order is determined by the Curves settings.</source>
    ...
    <message>
        ...
        <translation>以均匀间隔的X值插值Ys。</translation>
    </message>
    <message>
    ...
    <message>
        ...
        <translation>Theta标签：</translation>
    </message>
    <message>
...
Controls for specifying the format of relations during export</source>
    ...
    <message>
        ...
        <translation>在标题中为theta值标记</translation>
    </message>
    <message>
...
In addition to the points placed at regular intervals, this option causes a point to be placed at each corner. This option can capture important information in piecewise linear graphs, but gradually curving graphs may not benefit from the additional points</source>
    ...
    <message>
        ...
        <translation>预览窗口显示可填充段的最短行，以及由段填充生成的段和点的当前设置的影响</translation>
    </message>
</context>
<context>
...
Digitizes an axis point for a graph by placing a new point at the cursor after a mouse click. The coordinates of the axis point are then entered. In a graph, three axis points are required to define the graph coordinates.</source>
        <translation>数字化轴点点击鼠标后在光标处放置一个新点，为图形指定一个轴点。然后输入轴点坐标。在图中，需要三个轴点来定义图坐标。</translation>
    </message>
    <message>
...
Maps must be imported using Import (Advanced).</source>
        <translation>数字化比例尺通过单击并拖动来为地图的比例尺数字化。然后输入比例尺的长度。在地图中，比例尺的两个端点以图形坐标定义距离。必须使用导入（高级）导入地图。</translation>
    </message>
    <message>
