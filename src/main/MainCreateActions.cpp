...
void MainCreateActions::create(MainWindow &mw)
{
  LOG4CPP_INFO_S ((*mainCat)) << "MainCreateActions::create";

  createActionsFile (mw);
  createActionsEdit (mw);
  createActionsDigitize (mw);
  createActionsView (mw);
  createActionsSettings (mw);
  createActionsHelp (mw);
}

void MainCreateActions::createActionsDigitize (MainWindow &mw)
{
  LOG4CPP_INFO_S ((*mainCat)) << "MainCreateActions::createActionsDigitize";
...
void MainCreateActions::createActionsEdit (MainWindow &mw)
{
  LOG4CPP_INFO_S ((*mainCat)) << "MainCreateActions::createActionsEdit";
...
void MainCreateActions::createActionsFile (MainWindow &mw)
{
  LOG4CPP_INFO_S ((*mainCat)) << "MainCreateActions::createActionsFile";
...
void MainCreateActions::createActionsHelp (MainWindow &mw)
{
  LOG4CPP_INFO_S ((*mainCat)) << "MainCreateActions::createActionsHelp";
...
void MainCreateActions::createActionsSettings (MainWindow &mw)
{
  LOG4CPP_INFO_S ((*mainCat)) << "MainCreateActions::createActionsSettings";
...
void MainCreateActions::createActionsView (MainWindow &mw)
{
  LOG4CPP_INFO_S ((*mainCat)) << "MainCreateActions::createActionsView";
  ...
  // setShortCut is called by updateSettingsMainCreateActions
