...
/// Model for DlgSettingsMainWindow and CmdSettingsMainWindow. Unlike the other
/// models (DocumentModel*) this
/// data is not saved and loaded within the document, so no xml or working with
/// the Document class is involved. Instead,
/// the settings are saved using QSettings. Method involving xml/Document (from
/// DocumentModelAbstractBase) are stubbed out
