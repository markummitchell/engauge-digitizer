...
private:
  ...
  // If ChecklistLineEdits are added, they are all put into a single QWidget
  // since the spacing
  // in that QWidget can be set to zero. This prevents huge ugly gaps between
  // adjacent CheclistLineEdits
