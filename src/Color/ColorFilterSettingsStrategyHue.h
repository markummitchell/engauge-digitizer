...
#ifndef COLOR_FILTER_SETTINGS_STRATEGY_HUE_H
#define COLOR_FILTER_SETTINGS_STRATEGY_HUE_H

#include "ColorFilterSettingsStrategyAbstractBase.h"

/// Leaf class for hue strategy for ColorFilterSettings
class ColorFilterSettingsStrategyHue : public ColorFilterSettingsStrategyAbstractBase
{
 public:
  /// Single constructor.
...
#endif // COLOR_FILTER_SETTINGS_STRATEGY_HUE_H
