...
#ifndef COLOR_FILTER_SETTINGS_STRATEGY_VALUE_H
#define COLOR_FILTER_SETTINGS_STRATEGY_VALUE_H

#include "ColorFilterSettingsStrategyAbstractBase.h"

/// Leaf class for value strategy for ColorFilterSettings
class ColorFilterSettingsStrategyValue : public ColorFilterSettingsStrategyAbstractBase
{
 public:
  /// Single constructor.
...
#endif // COLOR_FILTER_SETTINGS_STRATEGY_VALUE_H
