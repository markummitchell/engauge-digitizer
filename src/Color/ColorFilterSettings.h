...
/// Color filter parameters for one curve. For a class, this is handled the same
/// as LineStyle and PointStyle
...
public:
  ...
  ColorFilterSettings(ColorFilterMode colorFilterMode, int intensityLow,
                      int intensityHigh, int foregroundLow, int foregroundHigh,
                      int hueLow, int hueHigh, int saturationLow,
  ...
  /// High value of foreground, hue, intensity, saturation or value according to
  /// current filter mode,
  ...
  /// Low value of foreground, hue, intensity, saturation or value according to
  /// current filter mode,
  /// normalized to 0 to 1.
  double low() const;
