...
/// Show a button with text for clicking ion. The button is implemented using
/// layering of two graphics items (text and rectangle)
...
public:
  ...
  /// Set the position. This is called after creation so screen extent is
  /// available for positioning calculations
