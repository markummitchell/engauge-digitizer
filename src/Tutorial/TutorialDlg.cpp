...
TutorialDlg::TutorialDlg(MainWindow *mainWindow) : QDialog(mainWindow) {
...
void TutorialDlg::createSceneAndView() {
  ...
  // Spacer is used to ensure view is the desired size. Directly setting the
  // size of the view
  // is ineffective since the view then get resized to the smallest rectangle
  // fitting the added items
  QGraphicsRectItem *spacer = new QGraphicsRectItem(
