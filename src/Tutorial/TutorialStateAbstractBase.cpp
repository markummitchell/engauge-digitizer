...
int TutorialStateAbstractBase::buttonMargin() const { return 10; }

TutorialStateContext &TutorialStateAbstractBase::context() { return m_context; }

QGraphicsPixmapItem *
TutorialStateAbstractBase::createPixmapItem(const QString &resource,
                                            const QPoint &pos) {
...
QGraphicsTextItem *
TutorialStateAbstractBase::createTextItem(const QString &text,
                                          const QPoint &pos) {
...
QGraphicsTextItem *TutorialStateAbstractBase::createTitle(const QString &text) {
  ...
  item->setPos(backgroundSize.width() / 2.0 -
