...
#ifndef CENTIPEDE_PAIR_POLAR_H
#define CENTIPEDE_PAIR_POLAR_H
...
/// Show two polar Centipede graphics items that the user interacts with by moving the cursor. This unique approach
...
/// for polar and constant-theta polar cases, and curved for constant-radius polar case). Shown below are
...
public:
  ...
  CentipedePairPolar(GraphicsScene &scene,
