...
const QString SETTINGS_EXPORT_ENDPOINTS_EVENLY_SPACED ("endpointsEvenlySpaced");
const QString SETTINGS_EXPORT_ENDPOINTS_FIRST_CURVE ("endpointsFirstCurve");
const QString SETTINGS_EXPORT_ENDPOINTS_GRID_LINES ("endpointsGridLines");
