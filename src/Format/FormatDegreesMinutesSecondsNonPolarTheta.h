...
class FormatDegreesMinutesSecondsNonPolarTheta
    : public FormatDegreesMinutesSecondsBase {
public:
  /// Single constructor
  FormatDegreesMinutesSecondsNonPolarTheta();

  /// Format the degrees/minutes/seconds value. Distinguishing x/theta versus
  /// y/radius is required for N/S/E/W hemispheres
  QString formatOutput(CoordUnitsNonPolarTheta coordUnits, double value,
                       bool isXTheta) const;
};
