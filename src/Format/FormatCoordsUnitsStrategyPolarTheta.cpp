...
double FormatCoordsUnitsStrategyPolarTheta::formattedToUnformatted(
  ...
  default:
    LOG4CPP_ERROR_S((*mainCat)) << "FormatCoordsUnitsStrategyPolarTheta::"
                                   "unformattedToFormattedStrategyPolarTheta";
...
QString FormatCoordsUnitsStrategyPolarTheta::unformattedToFormatted(
    double valueUnformatted, const QLocale &locale,
    CoordUnitsPolarTheta coordUnits, const Transformation &transformation,
  ...
  case COORD_UNITS_POLAR_THETA_DEGREES_MINUTES_SECONDS_NSEW: {
    FormatDegreesMinutesSecondsPolarTheta format;
    valueFormatted =
        format.formatOutput(coordUnits, valueUnformatted, IS_X_THETA);
  } break;
