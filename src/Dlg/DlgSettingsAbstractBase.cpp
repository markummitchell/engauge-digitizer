...
DlgSettingsAbstractBase::DlgSettingsAbstractBase(const QString &title,
    ...
    : QDialog(&mainWindow), m_mainWindow(mainWindow), m_cmdMediator(0),
      m_dialogName(dialogName), m_disableOkAtStartup(true) {
...
MainWindow &DlgSettingsAbstractBase::mainWindow() { return m_mainWindow; }

const MainWindow &DlgSettingsAbstractBase::mainWindow() const {
  return m_mainWindow;
}

void DlgSettingsAbstractBase::populateColorComboWithoutTransparent(
    QComboBox &combo) {
...
void DlgSettingsAbstractBase::populateColorComboWithTransparent(
    QComboBox &combo) {
...
void DlgSettingsAbstractBase::showEvent(QShowEvent * /* event */) {
  ...
  if (settings.contains(m_dialogName)) {
    ...
    // Restore the settings that were stored by the last call to
