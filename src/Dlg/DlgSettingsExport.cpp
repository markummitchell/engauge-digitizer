...
void DlgSettingsExport::createFileLayout (QHBoxLayout *layoutMisc)
{
  LOG4CPP_INFO_S ((*mainCat)) << "DlgSettingsExport::createFileLayout";
...
void DlgSettingsExport::createXLabel (QGridLayout *layoutHeader,
                                      int colLabel)
{
