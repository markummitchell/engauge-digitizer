...
DlgAbout::DlgAbout(MainWindow &mainWindow)
    : QMessageBox(&mainWindow), m_mainWindow(mainWindow) {
  ...
  setText(
      QString("%1 %2 %3 %4")
          ...
          .arg(tr("</p><p>&copy; 2014 Mark Mitchell</p>"
                  "<p>Engauge Digitizer is an open source tool for efficiently "
                  "extracting accurate numeric data from "
                  "images of graphs. The process may be considered as "
                  "\"inverse graphing\". When you \"engauge\" a document, "
                  "you are converting pixels into numbers.</p>"
                  "<p>This is free software, and you are welcome to "
                  "redistribute it under "
                  "certain conditions according to the GNU General Public "
                  "License Version 2,"
                  ...
                  "<ul>"
                  "<li><a href='http://digitizer.sourceforge.net'>Project Home "
                  "Page</a></li>"
                  "<li><a "
                  "href='http://sourceforge.net/forum/"
                  "forum.php?forum_id=229857'>Help Forum<a></li>"
                  "<li><a "
                  "href='http://sourceforge.net/forum/"
                  "forum.php?forum_id=229856'>Open Discussion Forum</a></li>"
                  "</ul>"
