...
const QString FORMAT_CSV_INTERNAL("text/engauge-points-csv"); // Custom mime
                                                              // type keeps
                                                              // points
                                                              // coordinates
                                                              // internal to
...
MimePoints::MimePoints(const QString &csvGraph, const QString &htmlGraph)
    : m_csvGraph(csvGraph), m_htmlGraph(htmlGraph) {
  m_formats << FORMAT_CSV << FORMAT_HTML << FORMAT_PLAIN;
}

MimePoints::MimePoints(const QString &csvPoints) : m_csvPoints(csvPoints) {
...
QString MimePoints::csvGraph() const { return m_csvGraph; }

QString MimePoints::csvPoints() const { return m_csvPoints; }

QStringList MimePoints::formats() const { return m_formats; }

QString MimePoints::htmlGraph() const { return m_htmlGraph; }
