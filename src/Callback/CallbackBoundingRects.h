...
/// Callback for computing the bounding rectangles of the screen and graph
/// coordinates of the points in the Document.
...
private:
  ...
  void mergeCoordinates(const QPointF &pos, QRectF &boundingRect);
