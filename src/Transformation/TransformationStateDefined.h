...
class TransformationStateDefined : public QObject,
                                   public TransformationStateAbstractBase {
  Q_OBJECT;
...
private:
  ...
  // As a QGraphicsItem subclass, the Checker is deleted by the QGraphicsScene
  // so it must be a pointer
