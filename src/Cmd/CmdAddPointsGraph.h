...
public:
  ...
  CmdAddPointsGraph(MainWindow &mainWindow, Document &document,
                    const QString &curveName, const QList<QPoint> &points,
...
private:
  ...
  QStringList m_identifiersAdded; // Points that got added. This is generated by
                                  // the Document during the Redo
};
