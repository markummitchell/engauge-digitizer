...
public:
  ...
  CmdAddPointGraph(MainWindow &mainWindow, Document &document,
...
private:
  ...
  QString m_identifierAdded; // Point that got added. This is generated by the
                             // Document during the Redo
};
