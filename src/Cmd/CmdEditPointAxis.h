...
/// Command for editing the graph coordinates one axis point. The screen
/// coordinates are
/// handled by another command
class CmdEditPointAxis : public CmdAbstract {
public:
  /// Constructor for normal creation
  CmdEditPointAxis(MainWindow &mainWindow, Document &document,
                   const QString &pointIdentifier,
                   const QPointF &posGraphBefore, const QPointF &posGraphAfter,
                   bool isXOnly);
