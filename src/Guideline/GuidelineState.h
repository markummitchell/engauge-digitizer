...
enum GuidelineState {
  ...
  GUIDELINE_STATE_DEPLOYED_CONSTANT_R_LOCKED_ACTIVE,
  GUIDELINE_STATE_DEPLOYED_CONSTANT_R_LOCKED_INACTIVE,
  ...
  GUIDELINE_STATE_DEPLOYED_CONSTANT_T_LOCKED_ACTIVE,
  GUIDELINE_STATE_DEPLOYED_CONSTANT_T_LOCKED_INACTIVE, 
  ...
  GUIDELINE_STATE_DEPLOYED_CONSTANT_X_LOCKED_ACTIVE,
  GUIDELINE_STATE_DEPLOYED_CONSTANT_X_LOCKED_INACTIVE,  
  ...
  GUIDELINE_STATE_DEPLOYED_CONSTANT_Y_LOCKED_ACTIVE,
  GUIDELINE_STATE_DEPLOYED_CONSTANT_Y_LOCKED_INACTIVE,  
