...
GuidelineProjectorConstantR::GuidelineProjectorConstantR(const Transformation &transformation,
...
void GuidelineProjectorConstantR::addSide (double num,
                                           double den,
                                           double x,
                                           double x1,
                                           double x2,
...
bool GuidelineProjectorConstantR::isOutside (const QPointF &posScreen,
...
QPointF GuidelineProjectorConstantR::pos1() const
{
  return m_pos1;
}

QPointF GuidelineProjectorConstantR::pos2() const
{
  return m_pos2;
}
