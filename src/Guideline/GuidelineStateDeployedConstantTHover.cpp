...
{
  // This event would have been handled by GUIDELINE_STATE_DEPLOYED_CONSTANT_T_NORMAL
}

void GuidelineStateDeployedConstantTHover::handleHoverLeaveEvent ()
{
  context().requestStateTransition(GUIDELINE_STATE_DEPLOYED_CONSTANT_T_NORMAL);
}
