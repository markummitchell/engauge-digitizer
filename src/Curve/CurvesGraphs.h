...
/// Container for all graph curves. The axes point curve is external to this
/// class.
class CurvesGraphs {
public:
  CurvesGraphs();
  ...
  void iterateThroughCurvesPoints(
      const Functor2wRet<const QString &, const Point &, CallbackSearchReturn>
          &ftorWithCallback);
  ...
  /// Update point ordinals to be consistent with their CurveStyle and x/theta
  /// coordinate
