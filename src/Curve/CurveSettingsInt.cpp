...
CurveSettingsInt::CurveSettingsInt(
    ...
    : m_colorFilterSettings(colorFilterSettings), m_pointStyle(pointStyle),
      m_lineStyle(lineStyle), m_curveConnectAs(curveConnectAs) {}
...
LineStyle CurveSettingsInt::lineStyle() const { return m_lineStyle; }

PointStyle CurveSettingsInt::pointStyle() const { return m_pointStyle; }
