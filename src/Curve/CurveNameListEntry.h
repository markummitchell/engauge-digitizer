...
/// Utility class for converting the QVariant in CurveNameList to/from the curve
/// names as QStrings, for use by
/// the CurveNameList model class. Subclassing QVariant brings up difficult
/// challenges, so the QString userType
/// was chosen.
///
/// Each entry has the current curve name, original curve name and point count,
