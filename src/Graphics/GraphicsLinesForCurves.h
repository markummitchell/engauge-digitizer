...
public:
  ...
  void addPoint(const QString &curveName, const QString &pointIdentifier,
  ...
  void updateAfterCommand(GraphicsScene &scene, const CurveStyles &curveStyles,
                          const QString &curveName, const Point &point);
