...
GraphicsPointPolygon::GraphicsPointPolygon(GraphicsPoint &graphicsPoint,
    ...
    : QGraphicsPolygonItem(polygon), m_graphicsPoint(graphicsPoint)
...
void GraphicsPointPolygon::setRadius(int radius) {
  // Resize assuming symmetry about the origin, and an aspect ratio of 1:1 (so x
  // and y scales are the same)
