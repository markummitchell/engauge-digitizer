...
/// Strategy base class for exporting to a file. This class provides common
/// methods
...
protected:
  /// Gnuplot requires, and other graphing tools probably prefer, blank lines
  /// between successive curves
  QString curveSeparator(const QString *string) const;

  /// Identify curves to include in export. The specified
  /// DocumentModelExportFormat overrides same data in Document for previewing
  /// window
  ...
  void insertLineSeparator(bool &isFirst, ExportHeader exportHeader,
