...
GeometryStrategyFunctionSmoothLegacy::GeometryStrategyFunctionSmoothLegacy()
{
}
...
void GeometryStrategyFunctionSmoothLegacy::calculateGeometry (const Points &points,
