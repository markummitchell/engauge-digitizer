...
private slots:
  ...
  // Test overfitted case, for which the order is equal to, or greater than, the number of points
  void testOverfit11 ();
  void testOverfit22 ();
  void testOverfit33 ();
  void testOverfit44 ();

  // Test underfitted case, for which the order is less than the number of points minus 1
  void testUnderfit02 ();
  void testUnderfit13 ();
  void testUnderfit24 ();
  void testUnderfit35 ();
