...
TestFormats::TestFormats(QObject *parent) : QObject(parent) {}
...
bool TestFormats::stateDegreesMinutesSeconds(const QString &string,
                                             QValidator::State stateExpected) {
  FormatDegreesMinutesSecondsBase format;
  double value;
  bool success = (stateExpected == format.parseInput(string, value));
  return success;
}

bool TestFormats::stateYearMonthDayHourMinuteSecond(
    const QString &string, QValidator::State stateExpected) {
  FormatDateTime format;
  double value;
  bool success =
      (stateExpected ==
       format.parseInput(COORD_UNITS_DATE_YEAR_MONTH_DAY,
                         COORD_UNITS_TIME_HOUR_MINUTE_SECOND, string, value));
  return success;
}
...
void TestFormats::testDateTime2015Slash0() {
  QVERIFY(
      stateYearMonthDayHourMinuteSecond("2015/0", QValidator::Intermediate));
}
...
void TestFormats::testDateTime2015Slash01Slash() {
  QVERIFY(
      stateYearMonthDayHourMinuteSecond("2015/01/", QValidator::Intermediate));
}

void TestFormats::testDateTime2015Slash01Slash0() {
  QVERIFY(
      stateYearMonthDayHourMinuteSecond("2015/01/0", QValidator::Intermediate));
}

void TestFormats::testDateTime2015Slash01Slash02() {
  QVERIFY(
      stateYearMonthDayHourMinuteSecond("2015/01/02", QValidator::Acceptable));
}
...
void TestFormats::testDateTime2015Slash01Slash02Space0() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 0",
                                            QValidator::Intermediate));
}

void TestFormats::testDateTime2015Slash01Slash02Space01() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 01",
...
void TestFormats::testDateTime2015Slash01Slash02Space01Colon0() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 01:0",
                                            QValidator::Intermediate));
}

void TestFormats::testDateTime2015Slash01Slash02Space01Colon02() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 01:02",
                                            QValidator::Acceptable));
}
...
void TestFormats::testDateTime2015Slash01Slash02Space01Colon02Colon0() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 01:02:0",
                                            QValidator::Intermediate));
}

void TestFormats::testDateTime2015Slash01Slash02Space01Colon02Colon03() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 01:02:03",
                                            QValidator::Acceptable));
}
...
void TestFormats::testDateTime2015Slash01Slash02Space01Colon02Colon03SpaceA() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 01:02:03 A",
                                            QValidator::Intermediate));
}

void TestFormats::testDateTime2015Slash01Slash02Space01Colon02Colon03SpaceAM() {
  QVERIFY(stateYearMonthDayHourMinuteSecond("2015/01/02 01:02:03 AM",
                                            QValidator::Acceptable));
}
