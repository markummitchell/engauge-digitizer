...
// Zero default for origin radius, which is usually wanted for
// COORD_SCALE_LINEAR, it is illegal
// for COORD_SCALE_LOG (for which 1.0 is probably preferred as the default. Note
// linear is more common than log
...
DocumentModelCoords::DocumentModelCoords(const DocumentModelCoords &other)
    : m_coordsType(other.coordsType()), m_originRadius(other.originRadius()),
      m_coordScaleXTheta(other.coordScaleXTheta()),
      m_coordScaleYRadius(other.coordScaleYRadius()),
      m_coordUnitsX(other.coordUnitsX()), m_coordUnitsY(other.coordUnitsY()),
...
DocumentModelCoords &DocumentModelCoords::
operator=(const DocumentModelCoords &other) {
...
CoordsType DocumentModelCoords::coordsType() const { return m_coordsType; }
...
void DocumentModelCoords::loadXml(QXmlStreamReader &reader) {
  ...
  if (attributes.hasAttribute(DOCUMENT_SERIALIZE_COORDS_TYPE) &&
    ...
    setCoordsType(
        (CoordsType)attributes.value(DOCUMENT_SERIALIZE_COORDS_TYPE).toInt());
    setOriginRadius(
        attributes.value(DOCUMENT_SERIALIZE_COORDS_ORIGIN_RADIUS).toDouble());
    setCoordScaleXTheta(
        (CoordScale)attributes.value(DOCUMENT_SERIALIZE_COORDS_SCALE_X_THETA)
            .toInt());
    setCoordScaleYRadius(
        (CoordScale)attributes.value(DOCUMENT_SERIALIZE_COORDS_SCALE_Y_RADIUS)
            .toInt());
    setCoordUnitsX((CoordUnitsNonPolarTheta)
                       attributes.value(DOCUMENT_SERIALIZE_COORDS_UNITS_X)
                           .toInt());
    setCoordUnitsY((CoordUnitsNonPolarTheta)
                       attributes.value(DOCUMENT_SERIALIZE_COORDS_UNITS_Y)
                           .toInt());
    setCoordUnitsTheta((CoordUnitsPolarTheta)attributes
                           .value(DOCUMENT_SERIALIZE_COORDS_UNITS_THETA)
                           .toInt());
    setCoordUnitsRadius((CoordUnitsNonPolarTheta)attributes
                            .value(DOCUMENT_SERIALIZE_COORDS_UNITS_RADIUS)
                            .toInt());
    setCoordUnitsDate(
        (CoordUnitsDate)attributes.value(DOCUMENT_SERIALIZE_COORDS_UNITS_DATE)
            .toInt());
    setCoordUnitsTime(
        (CoordUnitsTime)attributes.value(DOCUMENT_SERIALIZE_COORDS_UNITS_TIME)
            .toInt());
...
double DocumentModelCoords::originRadius() const { return m_originRadius; }
...
void DocumentModelCoords::printStream(QString indentation,
  ...
  str << indentation
      ...
      << "\n";
  str << indentation << "coordUnitsRadius="
      << coordUnitsNonPolarThetaToString(m_coordUnitsRadius) << "\n";
  str << indentation
...
void DocumentModelCoords::saveXml(QXmlStreamWriter &writer) const {
  ...
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_TYPE,
                        QString::number(m_coordsType));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_TYPE_STRING,
                        coordsTypeToString(m_coordsType));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_ORIGIN_RADIUS,
                        QString::number(m_originRadius));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_SCALE_X_THETA,
                        QString::number(m_coordScaleXTheta));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_SCALE_X_THETA_STRING,
                        coordScaleToString(m_coordScaleXTheta));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_SCALE_Y_RADIUS,
                        QString::number(m_coordScaleYRadius));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_SCALE_Y_RADIUS_STRING,
                        coordScaleToString(m_coordScaleYRadius));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_X,
                        QString::number(m_coordUnitsX));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_X_STRING,
                        coordUnitsNonPolarThetaToString(m_coordUnitsX));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_Y,
                        QString::number(m_coordUnitsY));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_Y_STRING,
                        coordUnitsNonPolarThetaToString(m_coordUnitsY));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_THETA,
                        QString::number(m_coordUnitsTheta));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_THETA_STRING,
                        coordUnitsPolarThetaToString(m_coordUnitsTheta));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_RADIUS,
                        QString::number(m_coordUnitsRadius));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_RADIUS_STRING,
                        coordUnitsNonPolarThetaToString(m_coordUnitsRadius));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_DATE,
                        QString::number(m_coordUnitsDate));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_DATE_STRING,
                        coordUnitsDateToString(m_coordUnitsDate));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_TIME,
                        QString::number(m_coordUnitsTime));
  writer.writeAttribute(DOCUMENT_SERIALIZE_COORDS_UNITS_TIME_STRING,
                        coordUnitsTimeToString(m_coordUnitsTime));
...
void DocumentModelCoords::setCoordUnitsRadius(
