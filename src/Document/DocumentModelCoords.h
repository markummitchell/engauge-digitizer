...
public:
  ...
  /// Return the period of the theta value for polar coordinates, consistent
  /// with CoordThetaUnits
...
private:
  ...
  CoordUnitsNonPolarTheta
      m_coordUnitsX; // Applies to x for cartesian coordinates
  CoordUnitsNonPolarTheta
      m_coordUnitsY; // Applies to y for cartesian coordinates
  CoordUnitsPolarTheta
      m_coordUnitsTheta; // Applies to theta for polar coordinates
  CoordUnitsNonPolarTheta
      m_coordUnitsRadius;          // Applies to radius for polar coordinates
