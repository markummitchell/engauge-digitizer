...
const QString DOCUMENT_SERIALIZE_DIGITIZE_CURVE_LINE_LENGTH ("CursorLineLength");
const QString DOCUMENT_SERIALIZE_DIGITIZE_CURVE_LINE_WIDTH ("CursorLineWidth");
