...
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_EVENLY_SPACED ("EndpointsEvenlySpaced");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_EVENLY_SPACED_STRING ("EndpointsEvenlySpacedString");
