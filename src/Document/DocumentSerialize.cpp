...
const QString DOCUMENT_SERIALIZE_CMD_DIGITIZE_STATE ("CmdDigitizeState");
...
const QString DOCUMENT_SERIALIZE_CMD_GUIDELINE_VIEW_STATE ("CmdGuidelineViewState");
...
const QString DOCUMENT_SERIALIZE_DIGITIZE_STATE_AFTER ("DigitizeStateAfter");
const QString DOCUMENT_SERIALIZE_DIGITIZE_STATE_BEFORE ("DigitizeStateBefore");
...
const QString DOCUMENT_SERIALIZE_GUIDELINE_VIEW_STATE_AFTER ("GuidelineViewStateAfter");
const QString DOCUMENT_SERIALIZE_GUIDELINE_VIEW_STATE_BEFORE ("GuidelineViewStateBefore");
