...
const QString
    DOCUMENT_SERIALIZE_CMD_SELECT_COORD_SYSTEM("CmdSelectCoordSystem");
const QString
    DOCUMENT_SERIALIZE_CMD_SETTINGS_AXES_CHECKER("CmdSettingsAxesChecker");
const QString
    DOCUMENT_SERIALIZE_CMD_SETTINGS_COLOR_FILTER("CmdSettingsColorFilter");
const QString DOCUMENT_SERIALIZE_CMD_SETTINGS_COORDS("CmdSettingsCoords");
const QString DOCUMENT_SERIALIZE_CMD_SETTINGS_CURVE_ADD_REMOVE(
    "CmdSettingsCurveAddRemove");
const QString DOCUMENT_SERIALIZE_CMD_SETTINGS_CURVE_PROPERTIES(
    "CmdSettingsCurveProperties");
const QString
    DOCUMENT_SERIALIZE_CMD_SETTINGS_DIGITIZE_CURVE("CmdSettingsDigitizeCurve");
...
const QString
    DOCUMENT_SERIALIZE_CMD_SETTINGS_GRID_REMOVAL("CmdSettingsGridRemoval");
const QString
    DOCUMENT_SERIALIZE_CMD_SETTINGS_MAIN_WINDOW("CmdSettingsMainWindow");
const QString
    DOCUMENT_SERIALIZE_CMD_SETTINGS_POINT_MATCH("CmdSettingsPointMatch");
...
const QString DOCUMENT_SERIALIZE_COMMON("Common"); // Superceded by
                                                   // DOCUMENT_SERIALIZE_GENERAL
                                                   // but kept so old documents
                                                   // can be loaded
...
const QString
    DOCUMENT_SERIALIZE_COORDS_SCALE_X_THETA_STRING("ScaleXThetaString");
const QString DOCUMENT_SERIALIZE_COORDS_SCALE_Y_RADIUS("ScaleYRadius");
const QString
    DOCUMENT_SERIALIZE_COORDS_SCALE_Y_RADIUS_STRING("ScaleYRadiusString");
...
const QString
    DOCUMENT_SERIALIZE_COORDS_UNITS_RADIUS_STRING("UnitsRadiusString");
...
const QString
    DOCUMENT_SERIALIZE_CURVES_ENTRY_CURVE_NAME_CURRENT("CurveNameCurrent");
const QString
    DOCUMENT_SERIALIZE_CURVES_ENTRY_CURVE_NAME_ORIGINAL("CurveNameOriginal");
...
const QString
    DOCUMENT_SERIALIZE_DIGITIZE_CURVE_CURSOR_INNER_RADIUS("CursorInnerRadius");
const QString
    DOCUMENT_SERIALIZE_DIGITIZE_CURVE_CURSOR_LINE_WIDTH("CursorLineWidth");
...
const QString DOCUMENT_SERIALIZE_ERROR_REPORT(
    "ErrorReport"); // Treated same as DOCUMENT_SERIALIZE_DOCUMENT
const QString DOCUMENT_SERIALIZE_EXPORT("Export");
const QString
    DOCUMENT_SERIALIZE_EXPORT_CURVE_NAME_NOT_EXPORTED("CurveNameNotExported");
const QString DOCUMENT_SERIALIZE_EXPORT_CURVE_NAME_NOT_EXPORTED_NAME(
    "CurveNameNotSupportedName");
const QString
    DOCUMENT_SERIALIZE_EXPORT_CURVE_NAMES_NOT_EXPORTED("CurveNamesNotExported");
...
const QString
    DOCUMENT_SERIALIZE_EXPORT_LAYOUT_FUNCTIONS_STRING("LayoutFunctionsString");
...
const QString
    DOCUMENT_SERIALIZE_GRID_REMOVAL_DEFINED_GRID_LINES("DefinedGridLines");
...
const QString
    DOCUMENT_SERIALIZE_LINE_STYLE_CONNECT_AS_STRING("ConnectAsString");
...
const QString
    DOCUMENT_SERIALIZE_POINT_MATCH_COLOR_ACCEPTED_STRING("ColorAcceptedString");
...
const QString
    DOCUMENT_SERIALIZE_POINT_MATCH_COLOR_REJECTED_STRING("ColorRejectedString");
