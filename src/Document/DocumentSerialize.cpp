...
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_AUTOMATIC ("EndpointsAutomatic");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_AUTOMATIC_STRING ("EndpointsAutomaticString");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_FIRST ("EndpointsFirst");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_FIRST_STRING ("EndpointsFirstString");
