...
const QString DOCUMENT_SERIALIZE_CMD_CLICK_ON_POINT ("CmdClickOnPoint");
...
const QString DOCUMENT_SERIALIZE_CMD_DIGITIZE_STATE_NEXT ("DigitizeStateNext");
...
const QString DOCUMENT_SERIALIZE_CMD_SETTINGS_MAIN_WINDOW ("CmdSettingsMainWindow");
