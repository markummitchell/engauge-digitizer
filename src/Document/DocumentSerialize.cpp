...
const QString DOCUMENT_SERIALIZE_GUIDELINE_CREATION_CIRCLE_RADIUS ("GuidelineCreationCircleRadius");
...
const QString DOCUMENT_SERIALIZE_GUIDELINE_LINE_WIDTH ("LineWidth");
