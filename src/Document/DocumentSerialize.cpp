...
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_EXTRAPOLATION ("EndpointsExtrapolation");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_EXTRAPOLATION_STRING ("EndpointsExtrapolationString");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_FIRST_CURVE ("EndpointsFirstCurve");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_FIRST_CURVE_STRING ("EndpointsFirstCurveString");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_GRID_LINES ("EndpointsGridLines");
const QString DOCUMENT_SERIALIZE_EXPORT_ENDPOINTS_GRID_LINES_STRING ("EndpointsGridLinesString");
