...
const QString DOCUMENT_SERIALIZE_CURVE_PROPERTIES ("CurveProperties");
const QString DOCUMENT_SERIALIZE_CURVE_PROPERTIES_CURVE_NAME ("CurveName");
const QString DOCUMENT_SERIALIZE_CURVE_PROPERTIES_LINE_STYLES ("LineStyles");
const QString DOCUMENT_SERIALIZE_CURVE_PROPERTIES_POINT_STYLES ("PointStyles");
const QString DOCUMENT_SERIALIZE_CURVE_NAME ("CurveName");
const QString DOCUMENT_SERIALIZE_CURVE_POINTS ("CurvePoints");
const QString DOCUMENT_SERIALIZE_CURVES ("Curves");
...
const QString DOCUMENT_SERIALIZE_POINT_IDENTIFIER_INDEX ("IdentifierIndex");
