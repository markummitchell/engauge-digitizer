...
ViewProfileScale::ViewProfileScale(int minimumWidth, QWidget *parent)
    : QLabel(parent), m_colorFilterMode(COLOR_FILTER_MODE_FOREGROUND) {
...
void ViewProfileScale::paintHue() {
  ...
  QLinearGradient gradient(QPointF(0.0, height() / 2.0),
