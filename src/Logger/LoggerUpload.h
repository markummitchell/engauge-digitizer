...
public:
  ...
  static void loggerAssert(const char *condition, const char *file,
  ...
  static void loggerCheckPtr(const char *pointer, const char *file,
                             int line) NO_RETURN_VALUE;

private:
  static void loggerOutput(const char *comment, const char *file, int line,
