...
extern void initializeLogging(const QString &name, const QString &filename,
                              bool isDebug);

// ##:##:##.### is skipped to cutting lines to remove dates does not remove any
// of the transform numbers
