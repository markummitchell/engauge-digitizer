...
public:
  ...
  /// PointStyle is not applied to the point within the Graph.
  ...
  virtual void checkAddPointAxis(const QPointF &posScreen,
                                 ...
                                 QString &errorMessage, bool isXOnly) = 0;
  ...
  /// See CurvesGraphs::curveForCurveName, although this also works for
  /// AXIS_CURVE_NAME.
  ...
  /// Load the curve names in the specified Engauge file into the current graph.
  /// This is called near the end of the import process only
  ...
  virtual void
  setModelAxesChecker(const DocumentModelAxesChecker &modelAxesChecker) = 0;

  /// Set method for DocumentModelColorFilter.
  virtual void
  setModelColorFilter(const DocumentModelColorFilter &modelColorFilter) = 0;
  ...
  virtual void setModelDigitizeCurve(
  ...
  virtual void
  setModelGridRemoval(const DocumentModelGridRemoval &modelGridRemoval) = 0;

  /// Set method for DocumentModelPointMatch.
  virtual void
  setModelPointMatch(const DocumentModelPointMatch &modelPointMatch) = 0;
