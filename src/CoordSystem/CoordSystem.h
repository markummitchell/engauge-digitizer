...
/// Storage of data belonging to one coordinate system. There can be one or more
/// coordinate systems per graph, and one or
...
public:
  ...
  /// Constructor for opened Graphs, and error report files. The specified file
  /// is opened and read
  ...
  /// Return true if y coordinate is undefined, otherwise x coordinae is
  /// undefined in DOCUMENT_AXES_POINT_REQUIRE_4 mode.
...
private:
  ...
  // DocumentModelColorFilter is not here since filtering settings are stored
  // inside the Curve class
  DocumentModelCoords m_modelCoords;
  // CurveStyles is not here since curve properties are stored inside the Curve
  // class
