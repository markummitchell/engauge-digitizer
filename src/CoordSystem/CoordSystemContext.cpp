...
void CoordSystemContext::addCoordSystems(
...
void CoordSystemContext::addPointAxisWithGeneratedIdentifier(
    const QPointF &posScreen, const QPointF &posGraph, QString &identifier,
    double ordinal, bool isXOnly) {
  LOG4CPP_INFO_S((*mainCat))
      << "CoordSystemContext::addPointAxisWithGeneratedIdentifier";

  m_coordSystems[m_coordSystemIndex]->addPointAxisWithGeneratedIdentifier(
...
void CoordSystemContext::addPointAxisWithSpecifiedIdentifier(
    ...
    const QString &identifier, double ordinal, bool isXOnly) {
  LOG4CPP_INFO_S((*mainCat))
      << "CoordSystemContext::addPointAxisWithSpecifiedIdentifier";

  m_coordSystems[m_coordSystemIndex]->addPointAxisWithSpecifiedIdentifier(
      posScreen, posGraph, identifier, ordinal, isXOnly);
}

void CoordSystemContext::addPointGraphWithGeneratedIdentifier(
    const QString &curveName, const QPointF &posScreen,
    QString &generatedIdentifier, double ordinal) {
  LOG4CPP_INFO_S((*mainCat))
      << "CoordSystemContext::addPointGraphWithGeneratedIdentifier";

  m_coordSystems[m_coordSystemIndex]->addPointGraphWithGeneratedIdentifier(
      curveName, posScreen, generatedIdentifier, ordinal);
}

void CoordSystemContext::addPointGraphWithSpecifiedIdentifier(
    const QString &curveName, const QPointF &posScreen,
    const QString &identifier, double ordinal) {
  LOG4CPP_INFO_S((*mainCat))
      << "CoordSystemContext::addPointGraphWithSpecifiedIdentifier";

  m_coordSystems[m_coordSystemIndex]->addPointGraphWithSpecifiedIdentifier(
...
void CoordSystemContext::checkAddPointAxis(const QPointF &posScreen,
  ...
  m_coordSystems[m_coordSystemIndex]->checkAddPointAxis(
      posScreen, posGraph, isError, errorMessage, isXOnly);
}
...
void CoordSystemContext::checkEditPointAxis(const QString &pointIdentifier,
  ...
  m_coordSystems[m_coordSystemIndex]->checkEditPointAxis(
      pointIdentifier, posScreen, posGraph, isError, errorMessage);
}
...
const Curve *
CoordSystemContext::curveForCurveName(const QString &curveName) const {
  LOG4CPP_INFO_S((*mainCat)) << "CoordSystemContext::curveForCurveName";
...
void CoordSystemContext::editPointAxis(const QPointF &posGraph,
  ...
  m_coordSystems[m_coordSystemIndex]->editPointAxis(posGraph, identifier);
}
...
void CoordSystemContext::iterateThroughCurvePointsAxes(
    const Functor2wRet<const QString &, const Point &, CallbackSearchReturn>
        &ftorWithCallback) {
  LOG4CPP_INFO_S((*mainCat))
      << "CoordSystemContext::iterateThroughCurvePointsAxes";

  m_coordSystems[m_coordSystemIndex]->iterateThroughCurvePointsAxes(
      ftorWithCallback);
}
...
void CoordSystemContext::iterateThroughCurveSegments(
  ...
  m_coordSystems[m_coordSystemIndex]->iterateThroughCurveSegments(
      curveName, ftorWithCallback);
}

void CoordSystemContext::iterateThroughCurvesPointsGraphs(
    const Functor2wRet<const QString &, const Point &, CallbackSearchReturn>
        &ftorWithCallback) {
  LOG4CPP_INFO_S((*mainCat))
      << "CoordSystemContext::iterateThroughCurvesPointsGraphs";

  m_coordSystems[m_coordSystemIndex]->iterateThroughCurvesPointsGraphs(
      ftorWithCallback);
}
...
void CoordSystemContext::loadPreVersion6(QDataStream &str, double version) {
  LOG4CPP_INFO_S((*mainCat)) << "CoordSystemContext::loadPreVersion6";

  m_coordSystems[m_coordSystemIndex]->loadPreVersion6(str, version);
}
...
void CoordSystemContext::loadVersion7(
    QXmlStreamReader &reader,
    DocumentAxesPointsRequired documentAxesPointsRequired) {
  LOG4CPP_INFO_S((*mainCat)) << "CoordSystemContext::loadVersion7";

  int indexLast = m_coordSystems.count() - 1;
  m_coordSystems[indexLast]->loadVersion7(reader, documentAxesPointsRequired);
}
...
QPointF
CoordSystemContext::positionGraph(const QString &pointIdentifier) const {
...
QPointF
CoordSystemContext::positionScreen(const QString &pointIdentifier) const {
  LOG4CPP_INFO_S((*mainCat)) << "CoordSystemContext::addGraphCurveAtEnd";
...
void CoordSystemContext::printStream(QString indentation,
  ...
  m_coordSystems[m_coordSystemIndex]->printStream(indentation, str);
}
...
void CoordSystemContext::removePointsInCurvesGraphs(
...
void CoordSystemContext::setCoordSystemIndex(
...
void CoordSystemContext::setModelAxesChecker(
...
void CoordSystemContext::setModelColorFilter(
...
void CoordSystemContext::setModelCoords(
...
void CoordSystemContext::setModelCurveStyles(
...
void CoordSystemContext::setModelDigitizeCurve(
...
void CoordSystemContext::setModelExport(
...
void CoordSystemContext::setModelGeneral(
...
void CoordSystemContext::setModelGridRemoval(
...
void CoordSystemContext::setModelPointMatch(
...
void CoordSystemContext::setModelSegments(
