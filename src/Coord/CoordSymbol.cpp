...
const QString POLAR_UNITS_DEGREES_MINUTES =
    ...
    QString(" MM.MMM") + QChar(COORD_SYMBOL_MINUTES_PRIME) + QString(")");
const QString POLAR_UNITS_DEGREES_MINUTES_SECONDS =
    QString("Degrees Minutes Seconds (DDD") + QChar(COORD_SYMBOL_DEGREES) +
    QString(" MM") + QChar(COORD_SYMBOL_MINUTES_PRIME) + QString(" SS.S") +
    QChar(COORD_SYMBOL_SECONDS_DOUBLE_PRIME) + QString(")");
const QString POLAR_UNITS_DEGREES_MINUTES_SECONDS_NSEW =
    QString("Degrees Minutes Seconds (DDD") + QChar(COORD_SYMBOL_DEGREES) +
    QString(" MM") + QChar(COORD_SYMBOL_MINUTES_PRIME) + QString(" SS.S") +
    QChar(COORD_SYMBOL_SECONDS_DOUBLE_PRIME) + QString(" NSEW)");
